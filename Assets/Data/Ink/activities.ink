=== activity_memorize ===
{ shuffle:
- You memorized tomorrow's class materials... #bg desk #box event
- You reviewed your notes and tested yourself on the key points... #bg desk #box event
- You repeated important facts in your head until they stuck... #bg desk #box event
- You used flashcards to reinforce what you learned... #bg desk #box event
- You tried to recall what you studied yesterday to strengthen memory... #bg desk #box event
}
~ addLogic(2)
-> END
...
=== activity_appreciate ===
{ shuffle:
- You listen to some classical music, focusing on the intricacies of the melody and rhythm... #bg desk #box event
- You researched modern painting and examined how it makes you feel... #bg desk #box event
- You watched a documentary about an artist and their work... #bg desk #box event
- You took a moment to admire the architecture of a nearby building... #bg desk #box event
- You listened to a poem being recited and reflected on its meaning... #bg desk #box event
}
~ addMood(2)
-> END
...
=== activity_writing ===
{ shuffle:
- You wrote a short story on success... #bg desk #box event
- You jotted down your thoughts in a journal... #bg desk #box event
- You created a poem about nature... #bg desk #box event
- You crafted a letter to your future self... #bg desk #box event
- You described a dream you had in vivid detail... #bg desk #box event
}
~ addMood(1)
-> END
...
=== activity_self_quiz ===
{ shuffle:
- You tested yourself with a few tricky questions... #bg desk #box event
- You tried to recall facts from memory without checking your notes... #bg desk #box event
- You challenged yourself with a set of flashcards... #bg desk #box event
- You wrote down answers to random questions to see what you still remember... #bg desk #box event
- You created a quiz for yourself and tried to beat your previous score... #bg desk #box event
}
~ addLogic(2)
-> END
...
=== activity_exercise ===
{ shuffle:
- You did some push ups... #bg desk #box event
- You went for a quick jog around the block... #bg desk #box event
- You stretched to loosen up your muscles... #bg desk #box event
- You practiced balancing on one foot for a minute... #bg desk #box event
- You lifted some light weights to build endurance... #bg desk #box event
}
~ addMood(1)
~ addLogic(1)
-> END
